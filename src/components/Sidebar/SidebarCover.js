...
function SidebarCover() {
    ...
    return (
        <div className="pt-[100%] relative 2xl:bg-black group lg:w-[85%] lg:h-[85%] lg:mx-auto 2xl:w-[100%] 2xl:h-[100%]">
            <img src={current.image} className=" object-cover absolute top-0 left-0" alt=""/>
            <button
